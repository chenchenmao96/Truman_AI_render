...
function tokenToScriptDescriptor(token, scriptPOL, aiTopicSet) {
    ...
    const fillerMap = {
        Park1: { class: "park", picture: "1.jpg" },
        Park2: { class: "park", picture: "2.jpg" },
        Park3: { class: "park", picture: "3.jpg" },

        Food1: { class: "food", picture: "1.jpg" },
        Food2: { class: "food", picture: "2.jpg" },

        Cat1: { class: "cat", picture: "1.jpg" },
        Cat2: { class: "cat", picture: "2.jpg" }
    };
